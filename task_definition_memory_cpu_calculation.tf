locals {
  ...
  xray_daemon_cpu_allocation                    = floor(var.task_definition_memory_cpu_configuration.cpu * try(var.side_car_resource_allocation_configuration.xray_daemon.cpu, 0.625))
